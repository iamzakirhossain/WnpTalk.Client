...
namespace WnpTalk.Client.Services.ChatHub
{
    public class ChatHub
    {
        ...
        public ChatHub(ServiceProvider serviceProvider)
        {
            ...
            var devSslHelper = new DevHttpsConnectionHelper(sslPort: 7227);
...
//#endif
        ...
        {
            await hubConnection.InvokeAsync("SendMessageToRoom", fromUserId, toRoomId, message);
        }
